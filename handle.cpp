...
{
     cout << "Each Soldier Report  Yourself!!" << endl
          << endl;
     ...
     for (size_t i = 0; i < number_of_commandos_in_a_group; i++)
     {
          cout << "Name: " << commando[i].get_Soldier_Name() << endl;
          cout << "Special Ability: " << commando[i].get_soldier_Special_Ability() << endl;
          cout << "Damage Value: " << commando[i].get_soldier_Damage_Value() << endl;
          cout << "--------------------------------------------------------------------------------------------------------------" << endl;
     }
     ...
     for (size_t i = 0; i < number_of_snipers_in_a_group; i++)
     {
          cout << "Name: " << sniper[i].get_Soldier_Name() << endl;
          cout << "Special Ability: " << sniper[i].get_soldier_Special_Ability() << endl;
          cout << "Damage Value: " << sniper[i].get_soldier_Damage_Value() << endl;
          cout << "--------------------------------------------------------------------------------------------------------------" << endl;
     }
     ...
     for (size_t i = 0; i < number_of_engineers_in_a_group; i++)
     {
          cout << "Name: " << engineer[i].get_Soldier_Name() << endl;
          cout << "Special Ability: " << engineer[i].get_soldier_Special_Ability() << endl;
          cout << "Damage Value: " << engineer[i].get_soldier_Damage_Value() << endl;
          cout << "--------------------------------------------------------------------------------------------------------------" << endl;
     }
     ...
     for (size_t i = 0; i < number_of_infantrymen_in_a_group; i++)
     {
          cout << "Name: " << infantryman[i].get_Soldier_Name() << endl;
          cout << "Special Ability: " << infantryman[i].get_soldier_Special_Ability() << endl;
          cout << "Damage Value: " << infantryman[i].get_soldier_Damage_Value() << endl;
          cout << "--------------------------------------------------------------------------------------------------------------" << endl;
     }

     /*--------------------------------------------------------------------------------------------------------------*/

     /*Artiellerymen Section*/
     cout << endl
          << "Artillerymen!!" << endl
          << "--------------------------------------------------------------------------------------------------------------"
          << endl
     ...
     for (size_t i = 0; i < number_of_artillerymen_in_a_group; i++)
     {
          cout << "Name: " << artilleryman[i].get_Soldier_Name() << endl;
          cout << "Special Ability: " << artilleryman[i].get_soldier_Special_Ability() << endl;
          cout << "Damage Value: " << artilleryman[i].get_soldier_Damage_Value() << endl;
          cout << "--------------------------------------------------------------------------------------------------------------" << endl;
     }
     ...
     for (size_t i = 0; i < number_of_tankers_in_a_group; i++)
     {
          cout << "Name: " << tanker[i].get_Soldier_Name() << endl;
          cout << "Special Ability: " << tanker[i].get_soldier_Special_Ability() << endl;
          cout << "Damage Value: " << tanker[i].get_soldier_Damage_Value() << endl;
          cout << "--------------------------------------------------------------------------------------------------------------" << endl;
     }
...
void Army ::Vehclies_Report()
{
     ...
     cout << "Each Vehicle Report  Itself!!" << endl
          << endl;
     ...
     for (size_t i = 0; i < number_of_tanks; i++)
     {
          cout << "Name: " << Tank[i].get_vehicle_name() << endl;
          cout << "Function: " << Tank[i].get_vehicle_function() << endl;
          cout << "--------------------------------------------------------------------------------------------------------------" << endl;
     }
     /*--------------------------------------------------------------------------------------------------------------*/
     ...
     for (size_t i = 0; i < number_of_helicopters; i++)
     {
          cout << "Name: " << Helicopter[i].get_vehicle_name() << endl;
          cout << "Function: " << Helicopter[i].get_vehicle_function() << endl;
          cout << "--------------------------------------------------------------------------------------------------------------" << endl;
     }
     /*--------------------------------------------------------------------------------------------------------------*/
}
